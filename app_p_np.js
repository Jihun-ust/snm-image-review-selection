// ====== CONFIG ======
const METADATA_URL = "images_p_np/metadata.csv";
...
startBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    metadata = parseCSV(csv).map((row) => ({
      ...
      imagePath: `./images_p_np/${row.filename}.png`,
...
acceptBtn.addEventListener("click", () => recordAndAdvance("possible"));
denyBtn.addEventListener("click", () => recordAndAdvance("not_possible"));